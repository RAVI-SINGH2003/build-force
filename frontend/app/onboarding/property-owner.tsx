...
// ─── Component ────────────────────────────────────────────────────
export default function PropertyOwnerOnboardingScreen() {
  // Form State
  ...
  const handleCompleteSetup = () => {
    ...
    console.log('Property Owner Profile:', {
      companyName, phone, city, state: indianState, bio
    });
      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.pageTitle}>BUILD YOUR PROFILE</Text>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.inputGroup}>
              {/* Note: In the reference image, Company Name does not have a required asterisk */}
